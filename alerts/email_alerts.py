...
def _build_news_section(news_alerts: List[dict]) -> str:
    ...
    for n in news_alerts:
        ...
        badge_color = _NEWS_COLORS.get(sentiment, "#6b7280")
        ...
        <tr style="border-bottom:1px solid #f3f4f6;">
          ...
          <td style="padding:9px 12px;white-space:nowrap;">
            <span style="background:{badge_color};color:#fff;padding:2px 8px;border-radius:4px;font-size:11px;font-weight:600;">
              {cat_label}
            </span>
          </td>
          <td style="padding:9px 12px;text-align:center;color:#ca8a04;font-size:12px;">{mag_star}</td>
      ...
      <table style="width:100%;border-collapse:collapse;font-size:13px;">
        <thead>
          <tr style="background:#fff7ed;border-bottom:1px solid #fed7aa;">
            ...
            <th style="padding:8px 12px;text-align:center;color:#9a3412;font-weight:600;">Signal</th>
